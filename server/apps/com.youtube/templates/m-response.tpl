    ...
    <table class="w-full mb-4">
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right w-1/2 text-itemCardTextpy-1 text-xs">{{likes}}</td>
            </tr>
            <tr>
                ...
                <td class="text-right w-1/2 text-itemCardTextpt-2 text-xs">{{comments}}</td>
            </tr>
        </tbody>
    </table>
    <a href="{{downloadLink}}" target="_blank" class="w-full bg-buttonGeneric text-xs text-secondaryLightText p-2 rounded-full hover:bg-buttonGenericDark mb-2 text-center">
        Download Video
    </a>
    <a href="{{youtubeLink}}" target="_blank" class="w-full bg-red-500 text-xs text-secondaryLightText p-2 rounded-full hover:bg-red-700 text-center">
        Open on YouTube
    </a>
</div>