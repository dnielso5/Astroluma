<div class="flex flex-col justify-center items-center h-full w-full p-2">
    ...
    <a href="{{repoLink}}" target="_blank" class="w-full bg-buttonGeneric text-xs text-secondaryLightText p-2 rounded-full hover:bg-buttonGenericDark mb-2 text-center">
        Open Repository
    </a>
</div>